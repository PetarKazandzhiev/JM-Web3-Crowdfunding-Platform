...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image, handleClick }) => {
  ...
  return (
    // when we give sm 2 parameters (in this case  w-[288px] w-full ) the latter is referring to
    // small devices while the former is referring to the medium and large devices
    <div className="sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer" onClick={handleClick}>
      ...
      <div className="flex flex-col p-4">
        ...
        <div className="block">
          {/* leading means line-height and truncate means that if the title is to long this is going to shorten it*/}
